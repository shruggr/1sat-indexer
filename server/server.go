...
import (
	...
	"github.com/shruggr/1sat-indexer/server/routes/acct"
	"github.com/shruggr/1sat-indexer/server/routes/blocks"
	"github.com/shruggr/1sat-indexer/server/routes/evt"
	"github.com/shruggr/1sat-indexer/server/routes/origins"
	"github.com/shruggr/1sat-indexer/server/routes/own"
	"github.com/shruggr/1sat-indexer/server/routes/sse"
	"github.com/shruggr/1sat-indexer/server/routes/tag"
	"github.com/shruggr/1sat-indexer/server/routes/tx"
	"github.com/shruggr/1sat-indexer/server/routes/txos"
)
